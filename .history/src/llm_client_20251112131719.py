...
class OpenAICompatibleClient:
    ...
    Works with local servers (llama.cpp, vLLM, TGI) that expose an OpenAI-like API.
    ...
    def chat(
        ...
        *,
        ...
        """extra_body is passed through (useful for vLLM's chat_template_kwargs)."""
        ...
        log.debug("POST %s payload=%s", url, json.dumps(payload)[:800])
